...
**7. When modeling and designing a system, which of the following aspects would you consider primary and the**


**foundation that drives the other aspects: user interface; data structures; or processing logic?**
